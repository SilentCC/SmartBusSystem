...
<script type="text/javascript">
	...
	function show1(index){
            ...
            formDiv+="ID:&nbsp&nbsp&nbsp&nbsp<input type='text' id='idshow' style='border-radius:10px;background-color:transparent;' name='id'/><br><br>";
            formDiv+="姓名:   <input type='text'  id='nameshow' style='border-radius:10px;background-color:transparent;' name='name'/><br><br>";
