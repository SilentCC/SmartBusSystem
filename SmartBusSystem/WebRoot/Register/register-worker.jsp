...
<h2 class="title" style="text-align:center">新增普通员工信息</h2><br/>
<div>
  ...
  <label>
    <span>姓名:</span>
    <input id="workername" type="text" name="workername"/>
  </label>
  <label>
    <span>性别 :</span>
  ...
  <label>
    <span>所属部门:</span>
    <select name="selection">
    <option value="sale">销售部</option>
    <option value="market">市场部</option>
    <option value="human">人力资源部</option>
