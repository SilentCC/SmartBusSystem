...
<script type="text/javascript">
	...
	function show(){
            ...
            formDiv+="ID:&nbsp&nbsp&nbsp&nbsp<input type='text' name='id'/><br><br>";
            formDiv+="姓名:   <input type='text' name='name'/><br><br>";
            formDiv+="性别:   <input type='text' name='sex'/><br><br>";
            formDiv+="所属部门: <input type='text' style='width:151px' name='department'/><br><br>";
            formDiv+="电话: <input type='text' name='tel'/><br><br>";
            formDiv+="住址: <input type='text' name='address'/><br><br>";              
              ...
              <form action="#" class="form">
                <table class="table">
                 ...
                 <c:forEach items="${PassengerList}" var="Item" varStatus="rowStatus" >  
  					...
  					<tr class="odd">
                    <td><input type="checkbox" class="checkbox" name="id" value="1" /></td><td>1</td><td>***</td>><td>男</td><td>销售部</td><td>12345</td><td>12345</td><td class="last"> <a onclick="show()">编辑</a><div class="pic" id="pic"></div> | <a href="#">删除</a></td>
                  </tr>
                </table>
          </form>
       </div>
