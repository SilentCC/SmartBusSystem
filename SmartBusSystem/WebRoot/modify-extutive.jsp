  ...
  <h1>行政人员个人信息修改</h1>
	...
	<div class="content2" style="height:63%">
		<form action="addExecutive" method="post">
			<input type="text" name="executiveID" id="executiveID" value="行政人员ID" onfocus="this.value = '';" onblur="if (this.value == '') {this.value = '行政人员ID';}">
...
$(function(){
    $('#executiveID').attr('disabled',true);
});
</script>
  </body>
</html>
