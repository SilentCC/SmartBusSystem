  ...
  <h1>普通员工个人信息修改</h1>
	<div class="content2" style="height:73%">
		<form action="addPassenger" method="post">
			<input type="text" name="passengerID" id="passengerID" value="普通员工ID" onfocus="this.value = '';" onblur="if (this.value == '') {this.value = '普通员工ID';}">
            ...
            <input type="text" name="department" id="department" value="所属部门" onfocus="this.value = '';" onblur="if (this.value == '') {this.value = '所属部门';}">
...
$(function(){
    $('#passengerID').attr('disabled',true);    
